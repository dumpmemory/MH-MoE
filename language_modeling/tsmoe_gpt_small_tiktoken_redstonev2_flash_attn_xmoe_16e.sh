...
python -m torch.distributed.launch --nproc_per_node=16 train.py /mnt/msranlp/shaohanh/data/redstone_v2_1_config/    \
    ...
    --seed 1 \
    --ddp-backend=c10d \
    --save-dir /mnt/msranlp/shaohanh/exp/ts_moe_exp/0605-small-baseline-redstone_v2-flash_attn-16experts \
    --tensorboard-logdir /mnt/msranlp/shaohanh/exp/ts_moe_exp/0605-small-baseline-redstone_v2-flash_attn-16experts/tb-logs      \
